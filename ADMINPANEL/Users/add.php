    <?php
     if(isset($_POST["submit"])){
						session_start();
   				$query1 = "INSERT INTO user (fname, username, email, password, address) VALUES ('{$_POST['fname']}','{$_POST['username']}', '{$_POST['login']}',md5('{$_POST['password']}'),'{$_POST['adresse']}') ";
...
<body> 
 <div class="container">  
  <form id="contact" action="127.0.0.127/zee/New folder/inscrit-next.php" method="POST">
    <?php
     if(isset($_POST["submit"])){
