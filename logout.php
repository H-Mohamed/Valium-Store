...
?>
 <?php
 $connection1=mysqli_connect('127.0.0.127', 'mohamed', 'Harir1997', 'valium');
...
content='3;URL= http://127.0.0.127/zee/New%20folder/login.php'>
</head>
...
<body> 
 ...
 <img src='lock.png'/></div></center><br>
<div class='page'>
...
Vous serez automatiquement redirigé vers la page de connexion .<br>
    ...
    <a style='text-decoration:none'href=' http://127.0.0.127/zee/New%20folder/login.php'>Cliquez ici</a>. 
</div>
</body> 
</html>
   "; 
